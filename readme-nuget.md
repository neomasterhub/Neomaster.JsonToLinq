...
| `as lower in` | `ExpressionOperators.InStrings` | Element converted to lower-case in collection |
| `as upper in` | `ExpressionOperators.InStrings` | Element converted to upper-case in collection |
