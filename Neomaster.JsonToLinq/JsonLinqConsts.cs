...
public static class JsonLinqConsts
{
  ...
  public static class ExpressionOperatorMappers
  {
    public static readonly ExpressionOperatorMapper Default = new ExpressionOperatorMapper()
      .Add("&", Expression.And)
      .Add("|", Expression.Or)
      .Add("&&", Expression.AndAlso).WithAliases("and")
      .Add("||", Expression.OrElse).WithAliases("or")
      .Add("=", Expression.Equal).WithAliases("eq")
      .Add("!=", Expression.NotEqual).WithAliases("neq")
      .Add(">", Expression.GreaterThan).WithAliases("gt")
