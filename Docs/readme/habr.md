...
## Почему не GraphQL<a name="why-not-graphql"/>
...
## Решение проблемы – JsonToLinq<a name="solution"/>
...
## Преимущества JsonToLinq<a name="advantages"/>
...
## Как использовать JsonToLinq<a name="usage"/>
...
## Тестирование JsonToLinq<a name="testing"/>
...
## Демонстрации и эксперименты<a name="demos"/>
...
## Потенциал JsonToLinq<a name="potential"/>
...
## Поддержать проект<a name="support"/>
